...
const validateEmail = () => {
  //   User model should have an active attribute that is false by default
  ...
  //   When user clicks the link and hits your route, check for the hash passed in the URL
  //   If  hash exists in the database, get the related user and set their active property to true
